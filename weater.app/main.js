...
// //fetch повертає проміс тому його обовязково потрібно обробити
...
//     // ФОРМУЄМО ЮРЛ ЗАПИТ (запит на бекенд або HTTP запит)
//     const BASE_URL = 'http://api.weatherapi.com/v1';
//     const API_KEY = 'f652ad30535645538aa180322242701'; // при реєстрації отримуємо

//     //forecast - ендпоінт
//     //вказуємо всі обовязкові параметри
