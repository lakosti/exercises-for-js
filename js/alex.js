...
//filter -- знаходить декілька елементів які задовільняють умову // якщо нічого не знайдено повертають пустий масив, навіть якщо знайшло один елемент все рівно буде масив
