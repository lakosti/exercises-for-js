...
//slice - вирізає, або додає елементи // не змінює масив // повертає копію // значення з мінусом починає вирізати з кінця // 0 - повністью весь масив //.slice(1, -1) - від першого до останнього
